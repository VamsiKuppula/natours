...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmFtc2kta2lyYW4ta3VwcHVsYSIsImEiOiJjazl3ZTQ4Z24wOG5pM2hta3Q2YXhzdGFhIn0.CDBiC0bGSmf8eN5NF0kkVQ';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend the map bounds to include loc
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_YXIGWmQgutINSQxzNOGTt4Rm00jyliRN6E'); // 1. Create a session from backend
